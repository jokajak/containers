...
-	**Where to file issues**:  
	[https://github.com/jokajak/containers/issues](https://github.com/jokajak/containers/issues)

-	**Maintained by**:  
	[Jokajak](https://github.com/jokajak/containers)

-	**Supported architectures**: 
	`arm32v7`(https://hub.docker.com/r/amd64/mariadb/)
...
Run `docker stack deploy -c stack.yml arm32v7/mariadb` (or `docker-compose -f stack.yml up`), wait for it to initialize completely, and visit `http://swarm-ip:8080`, `http://localhost:8080`, or `http://host-ip:8080` (as appropriate).
